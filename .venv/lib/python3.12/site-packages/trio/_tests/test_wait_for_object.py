...
async def test_WaitForMultipleObjects_sync_slow() -> None:
    # This does a series of tests in which the main thread sync-waits for
...
async def test_WaitForSingleObject() -> None:
    # This does a series of tests for setting/closing the handle before
    # initiating the wait.
...
async def test_WaitForSingleObject_slow() -> None:
    # This does a series of tests for setting the handle in another task,
    # and cancelling the wait task.

    # Set the timeout used in the tests. We tests the waiting time against
