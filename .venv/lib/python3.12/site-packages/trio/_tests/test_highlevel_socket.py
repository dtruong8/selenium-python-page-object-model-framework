...
async def test_SocketStream_basics() -> None:
    ...
    # Use a real, connected socket to tests socket options, because
...
async def test_SocketStream_send_all() -> None:
    ...
    with a_sock, b_sock:
        ...
        async def sender() -> None:
            ...
            # users. So tests that this doesn't happen, by forcing the
            ...
            # But I'm leaving the tests here in hopes that if this ever changes
