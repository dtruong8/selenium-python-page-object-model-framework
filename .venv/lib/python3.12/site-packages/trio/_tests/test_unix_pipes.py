...
async def test_misdirected_aclose_regression() -> None:
    ...
    async with FdStream(old_r_fd) as r2:
        ...
        async with _core.open_nursery() as nursery:
            ...
            # Here's the key tests: does calling aclose() again on the *old*
...
async def test_close_at_bad_time_for_send_all(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    async with s, r:
        async with _core.open_nursery() as nursery:
            ...
            # nursery never finishes all tasks and this tests hangs.
...
# for making an unreadable fd, so there's no way to run this tests. Fortunately
