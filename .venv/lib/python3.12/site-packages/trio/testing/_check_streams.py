...
async def check_one_way_stream(
    ...
    Raises:
      AssertionError: if a tests fails.
    ...
    # SSLStream. Unfortunately this tests isn't very thorough; the really
    ...
    if clogged_stream_maker is not None:
        ...
        async with _ForceCloseBoth(await clogged_stream_maker()) as (s, r):
            ...
            # this tests might destroy the stream b/c we end up cancelling
