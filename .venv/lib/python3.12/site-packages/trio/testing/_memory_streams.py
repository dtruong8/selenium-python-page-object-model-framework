...
def memory_stream_pair() -> (
    ...
    And here's a simple tests using our modified stream objects::
    ...
    functionality to keep your tests suite running quickly.

    If you want to stress tests a protocol implementation, one nice trick is to
