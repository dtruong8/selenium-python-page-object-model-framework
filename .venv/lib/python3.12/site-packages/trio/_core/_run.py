...
# to manage for each tests case, which together should make Trio's task
# scheduling loop deterministic.  We have a tests for that, of course.
...
class Deadlines:
    ...
    def _prune(self) -> None:
        ...
        # See test_cancel_scope_deadline_duplicates for a tests that exercises
        # this assert:
...
class Runner:
    ...
    async def wait_all_tasks_blocked(self, cushion: float = 0.0) -> None:
        ...
        tests, and will often produce more readable tests.

        Example:
          Here's an example of one way to tests that Trio's locks are fair: we
        ...
        while runner.tasks:
            ...
            while batch:
                ...
                if final_outcome is not None:
                    ...
                    # TODO: develop tests for this deletion
                    del msg
