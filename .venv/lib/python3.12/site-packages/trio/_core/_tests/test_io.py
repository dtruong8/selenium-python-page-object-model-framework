...
# / notify_closing.
# Note that if you use all three decorators on the same tests, it will run all
# N**3 *combinations*
...
async def test_can_survive_unnotified_close() -> None:
    ...
    #
    # This tests exercises some tricky "unnotified close" scenarios, to make
    ...
    # do that has been pulled out from under our feet... so tests that we can
    # survive this.
